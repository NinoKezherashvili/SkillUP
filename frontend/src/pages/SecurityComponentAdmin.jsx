...
function SecurityComponentAdmin() {
    ...
    <div className={styles.security}>
      ...
      <div className={styles.securitymodal}>
        ...
        <div className={styles.profilenavigation}>
          <Link to={"/welcomeadmin"} className={styles.backlink}>
            <img
              src={backarrow}
              alt="back arrow"
        ...
        <div className={styles.changepassword}>
          <button className={styles.buttonchange} onClick={sendPasswordData}>
            Change password
          </button>
        </div>
      </div>
...
export default SecurityComponentAdmin;
